...
INSERT INTO `field` VALUES (15,'texttt','text','blah blah',1,31),(18,'text','text','jsafd',1,34),(19,'choicee','choice','[\"one\",\"two\",\"three\"]',3,34),(20,'pictchure','image','/image/GNHazZY0P0Jj22GdyiSbeaYUU77KJLkI.jpg',5,34),(25,'מטרות המשחק','text','להנות ',1,40),(26,' גדשש','choice','[\"dd\",\"dd\",\"dd\"]',1,41),(27,'gfdg','text','hgchgfdgf',1,42),(28,'יגדעכחד','text','דיגכה',1,43),(29,'לחדגיכלח','text','דשלחגעכיח',1,44),(30,'םדגיכ','text','גלכחיע',1,47),(31,'דגלחכי','text','גדךלחמכ',2,47),(32,'כךלחדיכ','text','דגךלחמכ',1,48),(33,'לכטגטא','text','בעכגאכג',1,49);
...
INSERT INTO `school` VALUES (1,'sneakerers','בית שמש'),(31,'burn it','constintopale'),(32,'איריס','אחיהוד'),(33,'roonie','הרצליה'),(34,'טליה','ירושלים'),(35,'טווס','טטייךל'),(36,'חלחחמ','לחמלחמ'),(37,'klo','klooool'),(38,'trwfds','tjhrfg'),(39,'gfgfgfgfg','kjsdhfkjdsf'),(40,'hgfhgd','לחסבלח'),(41,'kjsfhsdf','oasuihd'),(42,'לחגדכ','ךצכלכ'),(43,'המסטר','דנס');
...
INSERT INTO `teacher_classroom` VALUES (1,'ef216bcb-736a-48d6-bb6c-de54ad679fc2');
...
-- Dump completed on 2021-04-04 10:51:18
