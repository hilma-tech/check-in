...
class AddTeacherPopUp extends Component {
    ...
    saveTeacherInDB = async () => {
        ...
        let teacherSaved = await this.props.addTeacherToClass(this.props.classIndex ,{
        ...
        if(teacherSaved.length === 0){
            this.props.closeFunc()
        } else {
            this.setState({ emailNameError: { toShow: ShowStyle, mess: teacherSaved } });
        }
    };
